...
public final class AppBarMainBinding implements ViewBinding {
  ...
  private AppBarMainBinding(@NonNull CoordinatorLayout rootView,
      @NonNull FrameLayout navHostFragmentContainer, @NonNull Toolbar toolbar) {
  ...
  public static AppBarMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FrameLayout navHostFragmentContainer = ViewBindings.findChildViewById(rootView, id);
      ...
      return new AppBarMainBinding((CoordinatorLayout) rootView, navHostFragmentContainer, toolbar);
    }
